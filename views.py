...
# app.config['SQLALCHEMY_DATABASE_URI']= "sqlite:////root/airflow/airflow.db"
from sqlalchemy import Column, Integer, String, Text, Index, Boolean

db = SQLAlchemy(app)

class someDataBase(db.Model):
    """
    ...
    dag_name = Column(String(100), unique=True)
    delay = Column(String(500))
